...
execute_process(
  COMMAND "C:/Users/Mateusz/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git show-ref "v1.3.5"
  WORKING_DIRECTORY "C:/Users/Mateusz/Documents/GitHub/city_simulator/cmake-build-debug/_deps/ogg-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Mateusz/Documents/GitHub/city_simulator/cmake-build-debug/_deps/ogg-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Mateusz/Documents/GitHub/city_simulator/cmake-build-debug/_deps/ogg-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
